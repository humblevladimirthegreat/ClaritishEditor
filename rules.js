...
const advices = [{    
    ...
    // }, {    
        ...
        regex: BARE_PERCENT_REGEX,
        advice: "Add <b>of [group]</b> after <b>{match}</b> to name what it is out of (or use <b>from A% to B%</b>, <b>N percentage points</b>, or <b>N% relative to [baseline]</b> for changes).",
